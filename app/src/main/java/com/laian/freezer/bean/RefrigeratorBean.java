...
public class RefrigeratorBean {
    ...
    /**
     * ipList : [{"diId":5,"diAddress":"192.168.1.200","diPort":1027,"diIsConnect":0,"diOperate":0,"diDeviceNumber":0,"sdsn":0}]
     ...
     * ehmList : [{"ehmId":1,"ehmAddress":1,"ehmName":"test","gallery":3,"ehmTemp":0,"ehmHum":0,"ehmMaxTemp":35,"ehmMinTemp":10,"ehmMaxHum":0,"ehmMinHum":0,"ehmInterval":30,"ehmType":"humi8","deviceLocationPojo":{"dlId":4,"dlName":"test"},"ip":3,"ipPort":"192.168.1.200:1025","number":0,"sn":0}]
     */
    ...
    public static class EhmListBean {
        ...
        public String getEhmType() {
            return ehmType;
        }

        public void setEhmType(String ehmType) {
            this.ehmType = ehmType;
        }
