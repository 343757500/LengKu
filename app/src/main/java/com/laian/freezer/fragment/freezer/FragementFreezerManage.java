package com.laian.freezer.fragment.freezer;
...
public class FragementFreezerManage extends FragmentAlert implements RecycleTempManageAdapter.OnItemClickListner {

    String action_getData = className + API.getFreezerManage;
    String action_add = className + API.addFreezerMachine;
//    String action_edt = className + API.edtTemp;
    String action_del = className + API.deleteFreezerMachine;
    ...
    public String[] getActions() {
        return new String[]{action_getData, action_add, action_del,  action_getIP, action_getLocation};
    }
    ...
    public void onHttpHandle(String action, String data) {
        ...
        if (getHttpStatus(data)) {
            if (action.equals(action_add) || action.equals(action_del)) {
                handleEdt(data);
