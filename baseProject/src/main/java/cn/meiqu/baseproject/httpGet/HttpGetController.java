...
//        HttpGetBase.newInstance().get(uri, params, action, responController);
    ...
    private void get(String uri,String action){
        HttpGetBase.newInstance().get(uri,action);
    }
...
//        }, 2 * 100);
    ...
    private void post(final String uri,FormBody body, final String action,String key,String value) {
//        BaseApp.mHandler.postDelayed(new Runnable() {
//            @Override
//            public void run() {
//                //LogUtil.log("------" + uri + "---" + params + "" + action+responController);
...
//    }
    ...
    public FormBody getBuild(String key,String value) {
    ...
    public void loginToServer(String loginName, String password, String className) {
        StringBuilder params = new StringBuilder();
        params.append("loginName="+loginName+"&password="+password);
        get(API.login,params.toString(),className);
    }


    public void getHome(String className){

        get(API.getHomePage,className);
    }

    public void getHomePage(String className) {
        post(API.getHomePage, getTokenBuild(), className);
    }
//    public void getHomeData(String className){
//        StringBuilder params = new StringBuilder();
//        get(API.getHomePage,params.toString(),className);
//    }
    ...
    public void getColdReal(String className) {
    ...
    public void getRefrigerReal(String className) {
        post(API.getRefrigerReal, getTokenBuild(), className);
    }
...
//        post(API.doorUpdateUrl, builder, className);
    ...
    public void getColdAlart(String deviceId, String startTime, String endTime, String className) {
        StringBuilder param = new StringBuilder();
    ...
    public void getColdManageList(String className) {
        post(API.getColdManage, getTokenBuild(), className);
    }

    public void getFridgeManageList(String className) {
    ...
    public void delColdManage(String id, String ip, String className) {
        StringBuilder param = new StringBuilder();
        param.append("id=" + id).append("&");
        param.append("ip=" + ip);
        get(API.delCold, param.toString(), className);
    }

    public void delFridgeManage(String id, String ip, String className) {
        StringBuilder param = new StringBuilder();
        param.append("id=" + id).append("&");
        param.append("ip=" + ip);
